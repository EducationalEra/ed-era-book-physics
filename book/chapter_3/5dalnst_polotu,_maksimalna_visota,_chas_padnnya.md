...
При цьому кутi Петро також визначив максимальну висоту пiдняття снаряда. Задоволений отриманими даними, вiн забрав гармату додому. Що ж, відтворимо експеримент Петра.</p>
<p>

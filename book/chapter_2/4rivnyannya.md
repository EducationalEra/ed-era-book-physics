...
$$S_{\text{прямокутника}} = (v_x-v_{0x})(t_2-t_1)=v_{0x}(t_2-t_1)=v_{0x}\Delta t \Rіghtarrow \boxed{S_x=v_{0x}\Delta t + \dfrac{a\Delta t^2}{2}}$$
...
<b><і>Розв’язок.</і></b> Направимо вісь $$x$$ в сторону руху, тоді $$v_{0x}>0, a_x &lt; 0$$.

<іmg class="іmage"  src="https://rawgіt.com/chudaol/ed-era-book-physіcs/master/іmages/chapter_2/7.svg" />
...
Щоб знайти час зупинки автомобіля, треба розв’язати рівняння швидкості (зупинка $$\rіghtarrow v_x=0$$)

    $$v_x=v_{0x}-at \Rіghtarrow 0=v_{0x}-at\Rіghtarrow t=\dfrac{v_{0x}}{a}$$

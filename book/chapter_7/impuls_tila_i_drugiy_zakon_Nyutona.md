...
$$
\vec{F}_{1зовн} + \vec{F}_{12} = m\vec{a}_1 \tag{1}
$$$$
\vec{F}_{2зовн} + \vec{F}_{21} = m\vec{a}_2 \tag{2}
$$
Як вже було зазначено, $$\vec{F}_{21} = -\vec{F}_{21}$$ за третiм законом Ньютона. Пiдставимо в рівняння $$(2)$$ силу $$\vec{F}_{21}$$.
$$

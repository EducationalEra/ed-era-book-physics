...
**Формульно**: Тiло пройшло шлях 5 метрiв за 5 секунд $$\Rightarrow$$ \[ v = \dfrac{l}{t} = \dfrac{5}{5}=1 \]
**Геометрично**: Прямокутний трикутник з катетами, величина кожного з яких = 5. З означення тангенса кута в прямокутному трикутнику: тангенс гострого кута - це вiдношення протилеглого катета $$(l)$$ до прилеглого $$t \thinspace \Rightarrow$$ \[ tg(\alpha)=\dfrac{l}{t} =1, \ \alpha = 45^\circ \]
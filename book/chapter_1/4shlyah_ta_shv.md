...
<question>
<p>Петро жбурляє бумеранг, який описує петлю у повiтрi i повертається у руки до Петра. Довжина описанної петлi 80 метрiв. Чому дорiвнює шлях i перемiщення бумеранга?</p>

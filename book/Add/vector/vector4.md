...
Для <b>геометричної побудови</b> вектора суми $$\vec{c} = \vec{a} + \vec{b}$$ використовують <b>«правило трикутника»</b> або <b>«правило паралелограма»</b>.
...
<h2>Множення вектора на скаляр</h2>
...
<div align="center" align="center"><img src="https://rawgit.com/chudaol/ed-era-book-physics/master/images/Add/vector/9.svg" /></div>
...
<h2>Проекція та розкладання вектора на компоненти</h2>

<b>Одиничним</b> називається вектор одиничної довжини.

<div class="space">Ті одиничні вектори, які співпадають з напрямками осей системи координат називають <b>ортами</b>.
...
Легко помітити, що <b>коефіцієнти при ортах – це координати вектора</b>, або, як ще називають, <b>проекції на осі координат</b>. Виконана операція називається <b>розкладанням вектора на проекції (компоненти)</b>.

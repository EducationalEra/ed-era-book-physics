...
<br>
— Нi. Адже, в даному випадку тіло обертатиметься із кутовим прискоренням. Тiло виводиться iз стану спокою пiд дiєю двох сил i починає обертатися. Кутова швидкiсть змiнюється, тож рiвновага вiдсутня.</div>
...
<div class="space"><p class="p3">Поговоримо про простий приклад iз повсякденного життя. Маємо звичайнi дверi та два випадки. Перший, ручка крiпиться на краю дверей, подалi вiд вiсi обертання. До такої ситуацiї ми звикли, так зазвичай i робиться. У другому випадку ручка прикрiплена ближче до осі обертання.</p></div>
...
<div class="space">Може iнтуiтивно ще не зрозумiло, але ми маємо знову стан рiвноваги. З першою умовою все, як завжди, зрозумiло, а от другу потрiбно розглянути детальніше.</div>

<p class="p3"><div class="space">Момент для першого вантажа не змiнився у порiвняннi з попереднiм прикладом: $$M_1 = -6d \cdot mg$$. Момент для подвiйного вантажу: сила = $$2mg$$, плече сили = $$3d$$, обертання за годинниковою стрiлкою ( «+» ). $$M_2 = 3d \cdot 2mg = 6d \cdot mg$$. Знову ж таки, друга умова рiвноваги виконується. Взагалi, це зрозумiло, адже в порiвнянні з першим моментом, тут було в два рази збiльшено силу, але в два рази зменшено плече.</div></p>
...
<div class="space">Тут вже маємо три ненульових моменти вiдносно вiсi обертання i знову ж таки маємо стан рiвноваги.</div> 
...
<div class="task-text">
<div class="space">Нажаль у свiтi iснують хитрi та недобросовiснi продавцi. Один з таких має точковий магнiт масою $$1$$ кг. На якiй вiдстанi вiд осi терезів вiн має прикрiпити його до плеча чашки у яку накладає товар, щоб обважувати покупцiв на $$200$$ г? Плечi терезів по $$20$$ см.</div>
...
<div class="space"><b><i>Розв’язок.</i></b> Отже, обважити на 200 г... Для цього магнiт повинен створювати той же момент сили вiдносно осi терезів, що i 200 г товару з плечем у 20 см:</div>
